...
class Rectify : ComponentActivity() {
    ...
    fun getResp(query:String, callback: (String) -> Unit) {
        ...
        val reqBody = """
        {
            "prompt": "You are a writing assistant that helps the user with correcting grammatical mistakes in their text. Correct the mistakes in the following text: $query",
            "max_tokens": 500,
            "temperature": 0
        }
    """.trimIndent()
